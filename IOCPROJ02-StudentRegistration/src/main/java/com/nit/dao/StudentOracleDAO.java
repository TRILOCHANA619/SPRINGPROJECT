...
public class StudentOracleDAO implements IStudentRedg {

	//DECLARE CLASS ELEMENT TO PRIVATE FOR ENCAPSULATION
	private DataSource ds;
	private static final String STUDENT_INSERT_QUERY="INSERT INTO STUDENT_TABLE VALUES(STD_SEQ.NEXTVAL,?,?,?,?,?,?,?)";

	//FOR THE INJECTING THE DATAsOURCE BY CONSTRUCTOR INJECTION
	public StudentOracleDAO(DataSource ds) {
		System.out.println("StudentOracleDAO.StudentOracleDAO()");
		this.ds = ds;
	}
